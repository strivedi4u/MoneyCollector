    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
             <div class="card">
                ...
                <form class="form-card" action="${pageContext.request.contextPath}/CONTROLLER/paymentdone" method="post">
                    ...
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Transaction Id<span class="text-danger"> *</span></label> <input type="text" id="job" name="payment_id" placeholder="Enter your Transaction Id" onblur="validate(11)"> </div>
                       <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Order Id<span class="text-danger"> *</span></label> <input type="text" id="ans" name="order_id" placeholder="Enter your Order Id" onblur="validate(12)"> </div>
                  
                    </div>
                     <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Signature<span class="text-danger"> *</span></label> <input type="text" id="ans" name="signature" placeholder="Enter your Signature" onblur="validate(13)"> </div>
                       <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Status<span class="text-danger"> *</span></label> <input type="text" id="ans" name="status" placeholder="Enter Status" onblur="validate(14)"> </div>
